...
const { getCourseDetails,SaleCreateCashfreeOrder, SaleCreateRazorpayOrder, SaleVerifyCashfreeOrder,SaleVerifyRazorpayPayment, GetCheckoutPage  } = require("../Controller/SaleController");
